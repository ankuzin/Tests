...
#Проверка наличия документа по номеру
...
# Запрос на получение всех имен владельцев документов
...
# Перемещение документа на полку
...
# Показать всю информацию о документе
